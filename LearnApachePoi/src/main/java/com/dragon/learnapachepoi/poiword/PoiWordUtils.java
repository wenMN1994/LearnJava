...
public class PoiWordUtils {
     ...
     * 合并标志
     */
    public static final String addRowMergeFlag = PLACEHOLDER_PREFIX + addRowMergeText;
     ...
     * @return
     */
    public static boolean isMergeRow(XWPFTableRow row) {
    	return isDynRow(row, addRowMergeFlag);
    }
